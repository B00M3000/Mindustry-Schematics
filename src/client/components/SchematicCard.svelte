...
<div class="schematic">
	<div class="tools">
		...
		<IconButton href="/schematics/{schematic._id}/edit" src="/assets/pencil.svg" alt="edit" />
		<IconButton href="/schematics/{schematic._id}/delete" src="/assets/trash.svg" alt="delete" />
	</div>
	<div class="view">
		<div class="name">
